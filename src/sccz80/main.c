...
static option  sccz80_opts[] = {
    ...
    { 0, "m8085", OPT_ASSIGN|OPT_INT, "Generate output for the i8085", &c_cpu, CPU_8085 },
    ...
    { 0, "fp-mode=ieee16", OPT_ASSIGN|OPT_INT, "Use 16 bit IEEE doubles", &c_maths_mode, MATHS_IEEE16 },
